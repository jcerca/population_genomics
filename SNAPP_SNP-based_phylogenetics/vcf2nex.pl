...
# single-line modification by JCerca, all the credits to the original file which is found in
# https://raw.githubusercontent.com/BEAST2-Dev/SNAPP/master/script/vcf2nex.pl
# READ the FAQ for SNAPP https://www.beast2.org/snapp-faq/
